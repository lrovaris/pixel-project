...
@Component({
  selector: 'pixel-create-enemy-page',
  templateUrl: './create-enemy-page.component.html',
  styleUrls: ['./create-enemy-page.component.scss']
})
export class CreateEnemyPageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    setTimeout( () => {
      ...
      this.filteredmetadataArray = this.metadataArray.filter( (image) => {
        console.log(image.metadata.spriteType.toLowerCase() === 'enemy');
        return image.metadata.spriteType.toLowerCase() === 'enemy';
      });
